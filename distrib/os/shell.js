...
(function (TSOS) {
    class Shell {
        ...
        init() {
            ...
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.shRunAll, "runall", "runs all loaded programs");
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.shPs, "ps", "display the PID and state of all processes");
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.shKill, "kill", "kill one process");
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.shKillAll, "killall", "kill all process");
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.shQuant, "quantum", "set the Round Robin quantum");
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.fCreate, "create", "creates new file");
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.fWrite, "write", "writes to a file");
            this.commandList[this.commandList.length] = sc;
            ...
            this.commandList[this.commandList.length] = sc;
            sc = new TSOS.ShellCommand(this.gtSched, "getschedule", "returns the current scheduling algorithm being used by the CPU.");
            this.commandList[this.commandList.length] = sc;
